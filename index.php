          ...
          <div class="collapse navbar-collapse" id="navbarNav">
            <ul   class="navbar-nav">         
              <li class="nav-item active ">
               <a style="color:white;"; class="nav-link" href="index.php">Inicio <span class="sr-only">(current)</span></a>
              </li>
              <li class="nav-item">
      ...
      <div class="CallToAction">
        ...
        <h1 class="p2 col-md-5">¿Quieres lucir con estilo?</h1>
          ...
          <div class="btn form-group ">
            <a style="margin-top: 15%;"class="btn btn-danger btn-lg "href="contacto.html">¡Contáctenos Ahora!</button></a>
        </div>
      </div>
      </div>
      </div>  
