  ...
  <body>
          ...
          <div class="collapse navbar-collapse" id="navbarNav">
            <ul   class="navbar-nav">         
              <li class="nav-item active ">
               <a style="color:white;"; class="nav-link" href="prueba.php">Inicio <span class="sr-only">(current)</span></a>
              </li>
              <li class="nav-item">
                <a style="color:white"; class="nav-link" href="nosotros.html">Nosotros </a>
              </li>
               <li class="nav-item">
                <a  style="color:white"; class="nav-link" href="contacto.html">Contactenos</a>
              </li>
              <li class="nav-item">
    ...
    <section>
      <div class="CallToAction">
        ...
        <div class="container-fluid">
        <div class="row">
        <h1 class="p2 col-md-5">¿Quieres lucir con estilo?</h1>
    ...
    <footer  style="background-color:black;"class="footer" >
      <section>
        ...
        <div class="container-fluid ">
        <div class="btn form-group btn-lg ">
        <a style="color:white;" class="btn btn-default btn-lg"href="prueba.php">Inicio</button></a>
        <a style="color:white;" class="btn btn-default btn-lg"href="nosotros.html">Nosotros</button></a>
        <a style="color:white;" class="btn btn-default btn-lg"href="contacto.html">Contactenos</button></a>
        ...
        <div Style="margin-left:74%;"%class="divFooter col-md-11">
          <a Style="font-family:bold;font-size:20px;color:white;">Siguenos En:</a>
